...
mst = pd.read_excel('//Vrcco-24/inv excel files/Monthly Inv Report.xlsx',sheet_name=-1)
name = mst.iloc[:, :3]
...
def get_most_similar_product(supplier, new_product_name, new_supplier_names, best_similarity, best_match_name):
    ...
    for supplier_name in new_supplier_names:
        ...
        print(new_product_name,similarity,supplier_name,predicted_supplier_name)
...
for product_name in list(name[name['Supplier'] == 'MWI']['Product']):
    ...
    best_similarity, best_match_name = get_most_similar_product('MWI', product_name, new_supplier_data['MWI'],
                                                                best_similarity, best_match_name)
